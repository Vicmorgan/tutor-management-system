  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-on-surface-variant mt-1">Your upcoming classes and recurring schedule.</p>
      </div>
            ...
            {isLoading ? (
              ...
              (a.schedules || []).map((s: any) => (
                <tr key={s.id} className="hover:bg-surface-container-low transition-colors">
                  ...
                  <td className="px-6 py-4 text-on-surface">{a.student?.user?.full_name || 'Assigned Student'}</td>
